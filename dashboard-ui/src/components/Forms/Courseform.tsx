          ...
          <h1 className="text-2xl font-semibold self-start">{type === "Create" ? "Create A New" : "Update"} Course</h1>
          {/* Top */}
          <h2 className="text-gray-500 self-start tex-sm font-semibold">Course info</h2>
