...
const handleMenuClick = () => {
  ...
  return (
    ...
    <nav className="flex justify-between items-center w-full lg:w-[70%] mx-auto lg:flex-row">
     <div className="border-2 border-black p-3 font-semibold text-sm lg:text-xl"><a className="text-blue-900" href="">LAHIIBA <span className="text-black">MANAGEMENT</span> <span className="text-red-800">IN...</span></a></div> 
   ...
   className=" w-full flex flex-col text-center font-semibold justify-center imageBackground text-white text-sm lg:text-2xl" >
    ...
    <section className="p-5 w-full">
      <h1 className=" text-2xl lg:text-[40px] text-[#625757] text-center" >Students Admission and Registration Information</h1>
    <ol style={{listStyleType :"lower-roman",paddingLeft:"1rem", color: "black"}} className="flex flex-col gap-4 pl-4 w-full lg:w-[70%] m-auto">
      <li className="w-full text-gray-500 flex flex-col gap-3 lg:text-2xl">
       <h2 className="text-sm lg:text-[30px] font-semibold text-gray-900">REQUIREMENTS FOR ADMISSION INTO THE FIRST YEAR OF THE HND/BTS/SRN PROGRAM</h2>
     ...
     <h3>2. The following documents should be attached to the completed application form;</h3>
        ...
        <p className="font-sm">The above documents in a self-addressed file should be submitted to the Admissions Office (Room one of the Central administrative Block). The applicant shall be granted provisional admission upon submission pending study of file and granting of final admission by the Admission Commission, wherein admission letters shall be issued to the students admitted. Contact example@mail.com or visit our website:
           laureateuniversityinstitute.com should you require more information</p>
        </ol></li>
      <li className="w-full text-gray-500 flex flex-col gap-3 lg:text-2xl">
          <h2 className=" text-sm lg:text-[30px] font-semibold text-gray-900">REQUIREMENTS FOR ADMISSION INTO THE ONE YEAR TOP-UP DEGREE PROGRAMME</h2>
        <h3>1. Applicants should fill and submit the online admission application form at the following page
          <a className="text-blue-500 text-sm underline" href=""> click here</a>
          </h3>
          <h3>2. The following documents should be attached to the completed application form;</h3>
        ...
        <li className=""> Photo copy of receipt of payment of registration fee, and,</li>
        <li className="">4* 4 passport size photograph affixed to the application form.</li>
        <p className="font-sm">The above documents in a self-addressed file should be submitted to the Admissions Office.
        ...
        website:<Link className="text-blue-500 underline" href="https://laureateuniversityinstitute.com">laureateuniversityinstitute.com</Link> should you require more information</p>
        </ol></li>
      ...
      <li className="w-full text-gray-500 flex flex-col gap-3 lg:text-2xl">
        ...
        <p>The above documents in a self-addressed file should be submitted to the Admissions Office
 ...
 <footer className=" bg-[#262323] w-fulL">
     ...
     <div className="bg-[#271288]  rounded-full w-[50px] h-[50px] p-5 flex items-center hover:rounded-[10px] "><Link href={""}><Image src={"/facebook.png"} width={100} height={60} alt="" /></Link></div>
     <div className="bg-[#271288]  rounded-full w-[50px] h-[50px] p-4 hover:rounded-[10px] "><Link href={""}><Image src={"/tiktok.png"} width={100} height={100} alt="" /></Link></div>
     <div className="bg-[#271288] rounded-full w-[50px] h-[50px] p-4 hover:rounded-[10px] "><Link href={""}><Image src={"/mail.png"} width={100} height={100} alt="" /></Link></div>
     </div>
     </div>
      ...
      <div className="">
        ...
        <ul className="flex flex-col gap-1 hover:text-shadow-neutral-800 " >
          ...
          <li className="hover:text-[#271288] hover:pl-[1rem]"><a href="">ADMISION AND REGISTRATION</a></li>
