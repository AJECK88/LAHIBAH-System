    ...
    <div className="flex flex-col xl:flex-row gap-4 p-4 bg-white rounded-md w-full">
      ...
      <div className="w-full xl:w-2/3 flex flex-col gap-4">
        ...
        <div className="flex flex-col lg:flex-row gap-4 w-full">
          {/* User Profile Card */}
          <div className="bg-blue-200 border border-blue-300/50 p-5 rounded-xl flex-1 flex flex-col sm:flex-row items-center sm:items-start gap-5 shadow-sm transition-all duration-200 hover:shadow-md">
            <div className="relative shrink-0">
              <Image
                ...
                height={96}
                style={{ height: "auto" }}
                className="w-24 h-24 rounded-full object-cover ring-4 ring-white/60 shadow-sm"
                priority
              />
            </div>

            <div className="w-full flex flex-col justify-between gap-3 min-w-0 text-center sm:text-left">
              <div>
                <h1
              ...
              {/* User Metadata Grid */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs font-medium text-slate-700 pt-2 border-t border-blue-300/60">
                {/* Blood Group */}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-3 w-full lg:w-auto">
            {/* Attendance */}
            <div className="bg-white border border-slate-100 p-4 rounded-xl flex items-center gap-3.5 shadow-sm hover:shadow-md transition-all duration-200 min-w-[130px]">
              <Image
